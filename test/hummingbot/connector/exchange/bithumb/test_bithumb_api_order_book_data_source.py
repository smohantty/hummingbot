...
class BithumbAPIOrderBookDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    async def asyncSetUp(self) -> None:
        ...
        self.connector = BithumbExchange(
            ...
            domain=self.domain)
        self.data_source = BithumbAPIOrderBookDataSource(trading_pairs=[self.trading_pair],
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.bithumb.bithumb_api_order_book_data_source"
           ".BithumbAPIOrderBookDataSource._sleep")
