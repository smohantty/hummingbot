...
class BithumbUserStreamDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    async def asyncSetUp(self) -> None:
        ...
        self.auth = BithumbAuth(api_key="TEST_API_KEY", secret_key="TEST_SECRET", time_provider=self.mock_time_provider)
    ...
    async def test_get_listen_key_log_exception(self, mock_api):
        url = web_utils.private_rest_url(path_url=CONSTANTS.BITHUMB_USER_STREAM_PATH_URL, domain=self.domain)
    ...
    @patch("hummingbot.connector.exchange.bithumb.bithumb_api_user_stream_data_source.BithumbAPIUserStreamDataSource"
           "._ping_listen_key",
